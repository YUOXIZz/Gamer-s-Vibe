...
#### PS:Windows Defender will report the V1.1 version as Trojan horse virus, it couldn't be fixed by my coding agent, so if you are worried about it, just use v1.0 version.
